      ...
      <section style={{ maxWidth: '1280px', margin: '0 auto', padding: '60px 24px 20px 24px' }}>
        ...
        >
          <div style={{
            ...
            <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3.2rem)', fontWeight: 800, color: '#FFFFFF', marginBottom: '12px' }}>
              Behind the <span className="text-gradient">Screens</span>
            </h2>

            <p style={{ color: 'var(--text-muted)', fontSize: '1.08rem', lineHeight: '1.6', marginBottom: '28px', maxWidth: '640px' }}>
